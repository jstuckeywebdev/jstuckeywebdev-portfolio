<article class="shadow-2xla w-[70vw] sm:w-100 shrink-0 snap-center md:snap-start flex flex-col bg-slate-900 rounded-xl overflow-hidden border border-slate-800/60 hover:border-indigo-500/30 transition-all duration-300 group">    
    ...
    <div class="p-4 flex flex-col flex-grow justify-between">
        ...
        <div class="flex items-center gap-4 text-xs font-mono mt-auto pt-2 border-t border-slate-800/50">
            <?php if ( $live_url ) : ?>
                <a href="<?php echo esc_url($live_url) ?>" target="_blank" rel="noopener" class="text-indigo-400 hover:text-indigo-300 transition-colors">Live Demo →</a>
            <?php endif; ?>
